...
image_names = [
    file for file in os.listdir(f"{os.getcwd()}\images") if file.endswith(".jpg")
]
...
if image is None:
    ...
    while True:
        ...
        cv2.imwrite(f"{os.getcwd()}\\results\{image_name}\ycrcb.jpg", ycrcb_image)
